...
import PhotoProfile from './../assets/img/foto-ilham.jpg';
            ...
            <div className='grid grid-flow-row w-full mr-3'>
                <div className='flex'>
                    <div className="flex w-full" style={{width:"60vw", height:"3vw"}}>
                        <Button label="Input Kepsek" className="p-button-info shadow-lg" icon="pi pi-plus" onClick={()=>{setNewAdmin(true)}}></Button>
                        <Dialog 
                            header="Input User" 
                            visible={newAdmin} 
                            style={{ width: '25vw', minWidth: '10rem' }} 
